 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vt=globalThis,Z=vt.trustedTypes,It=Z?Z.createPolicy("lit-html",{createHTML:o=>o}):void 0,Xt="$lit$",_=`lit$${Math.random().toFixed(9).slice(2)}$`,Zt="?"+_,Ce=`<${Zt}>`,S=document,D=()=>S.createComment(""),B=o=>o===null||typeof o!="object"&&typeof o!="function",wt=Array.isArray,Pe=o=>wt(o)||typeof o?.[Symbol.iterator]=="function",it=`[ 	
   ...
   */
    ...
    @media (min-width: 1200px) {
      ...
      .contact-page {
        max-width: 1500px;
        margin: 0 auto;
        padding: 16px clamp(40px, 6vw, 100px);
      }
      ...
      ${this.showInstallDialog?f`
            ...
            >
              <div>
                ...
                <span>
                  오프라인에서 앱을 사용할 수 있어요. 설치하려면 다음 "설치화면"에서 "설치"버튼을 눌러주세요.
                </span>
              </div>
...
//# sourceMappingURL=index-YE1F6ngM.js.map
