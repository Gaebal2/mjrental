import{i as l,c as p,S as h,H as b,x as c,e as m,r as u,t as v}from"./index-BCje4kh1.js";const g=l`
...
`,n=class extends h{constructor(){super(...arguments),this.hasSlotController=new b(this,"footer","header","image")}render(){return c`
      <div
        part="base"
    ...
    `}};n.styles=[p,f];n.define("sl-card");var y=Object.defineProperty,w=Object.getOwnPropertyDescriptor,x=(i,a,d,e)=>{for(var r=e>1?void 0:e?w(a,d):a,o=i.length-1,s;o>=0;o--)(s=i[o])&&(r=(e?s(a,d,r):s(r))||r);return e&&r&&y(a,d,r),r};let t=class extends u{render(){return c`
    ...
    `}};t.styles=[_,g];t=x([v("app-about")],t);export{t as AppAbout};
//# sourceMappingURL=app-about-c3vfBiwS.js.map
